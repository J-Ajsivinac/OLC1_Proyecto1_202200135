...
public class BlankPlotChartLine extends JComponent {

    public BlankPlotChatRenderLine getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChatRender(BlankPlotChatRenderLine blankPlotChatRender) {
    ...
    private BlankPlotChatRenderLine blankPlotChatRender;

    public BlankPlotChartLine() {
